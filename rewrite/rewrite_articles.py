...
class ArticleRewriter:
 ...
 print(f" Warning - {result['unmarked_product_links']} unmarked product links found")
 ...
 print(f" Warning - {result['possessive_references_found']} possessive references found (our/we/us)")
